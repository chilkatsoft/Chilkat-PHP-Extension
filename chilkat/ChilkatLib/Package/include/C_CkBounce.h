...
CK_VISIBLE_PUBLIC BOOL CkBounce_getLastMethodSuccess(HCkBounce cHandle);
CK_VISIBLE_PUBLIC void CkBounce_putLastMethodSuccess(HCkBounce cHandle, BOOL newVal);
