...
CK_VISIBLE_PUBLIC void CkHttpRequest_putBoundary(HCkHttpRequest cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkHttpRequest_boundary(HCkHttpRequest cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkHttpRequest_getLastMethodSuccess(HCkHttpRequest cHandle);
CK_VISIBLE_PUBLIC void CkHttpRequest_putLastMethodSuccess(HCkHttpRequest cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkHttpRequest_StreamChunkFromFile(HCkHttpRequest cHandle, const char *path, const char *offset, const char *numBytes);
