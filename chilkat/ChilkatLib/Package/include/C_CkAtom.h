...
CK_VISIBLE_PUBLIC BOOL CkAtom_getLastMethodSuccess(HCkAtom cHandle);
CK_VISIBLE_PUBLIC void CkAtom_putLastMethodSuccess(HCkAtom cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC HCkTask CkAtom_DownloadAtomAsync(HCkAtom cHandle, const char *url);
