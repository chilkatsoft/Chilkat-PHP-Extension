...
CK_VISIBLE_PUBLIC const wchar_t *CkScpW_downloadBinaryEncoded(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encoding);
CK_VISIBLE_PUBLIC HCkTaskW CkScpW_DownloadBinaryEncodedAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encoding);
CK_VISIBLE_PUBLIC BOOL CkScpW_DownloadFile(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *localPath);
CK_VISIBLE_PUBLIC HCkTaskW CkScpW_DownloadFileAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *localPath);
CK_VISIBLE_PUBLIC BOOL CkScpW_DownloadString(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *charset, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkScpW_downloadString(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *charset);
CK_VISIBLE_PUBLIC HCkTaskW CkScpW_DownloadStringAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *charset);
CK_VISIBLE_PUBLIC BOOL CkScpW_SaveLastError(HCkScpW cHandle, const wchar_t *path);
CK_VISIBLE_PUBLIC BOOL CkScpW_SyncTreeDownload(HCkScpW cHandle, const wchar_t *remoteRoot, const wchar_t *localRoot, int mode, BOOL bRecurse);
...
CK_VISIBLE_PUBLIC HCkTaskW CkScpW_UploadBinaryEncodedAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encodedData, const wchar_t *encoding);
CK_VISIBLE_PUBLIC BOOL CkScpW_UploadFile(HCkScpW cHandle, const wchar_t *localPath, const wchar_t *remotePath);
CK_VISIBLE_PUBLIC HCkTaskW CkScpW_UploadFileAsync(HCkScpW cHandle, const wchar_t *localPath, const wchar_t *remotePath);
CK_VISIBLE_PUBLIC BOOL CkScpW_UploadString(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *textData, const wchar_t *charset);
CK_VISIBLE_PUBLIC HCkTaskW CkScpW_UploadStringAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *textData, const wchar_t *charset);
CK_VISIBLE_PUBLIC BOOL CkScpW_UseSsh(HCkScpW cHandle, HCkSshW sshConnection);
#endif
