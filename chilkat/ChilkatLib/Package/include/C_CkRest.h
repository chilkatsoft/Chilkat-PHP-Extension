...
CK_VISIBLE_PUBLIC void CkRest_putHost(HCkRest cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkRest_host(HCkRest cHandle);
CK_VISIBLE_PUBLIC int CkRest_getIdleTimeoutMs(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_putIdleTimeoutMs(HCkRest cHandle, int newVal);
CK_VISIBLE_PUBLIC void CkRest_getLastErrorHtml(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkRest_lastErrorHtml(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_getLastErrorText(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkRest_lastErrorText(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_getLastErrorXml(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkRest_lastErrorXml(HCkRest cHandle);
CK_VISIBLE_PUBLIC BOOL CkRest_getLastMethodSuccess(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_putLastMethodSuccess(HCkRest cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC void CkRest_getLastRequestHeader(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkRest_lastRequestHeader(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_getLastRequestStartLine(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkRest_lastRequestStartLine(HCkRest cHandle);
CK_VISIBLE_PUBLIC int CkRest_getNumResponseHeaders(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_getPartSelector(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkRest_putPartSelector(HCkRest cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkRest_partSelector(HCkRest cHandle);
CK_VISIBLE_PUBLIC BOOL CkRest_getPercentDoneOnSend(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_putPercentDoneOnSend(HCkRest cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC void CkRest_getResponseHeader(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkRest_responseHeader(HCkRest cHandle);
CK_VISIBLE_PUBLIC int CkRest_getResponseStatusCode(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_getResponseStatusText(HCkRest cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkRest_responseStatusText(HCkRest cHandle);
CK_VISIBLE_PUBLIC BOOL CkRest_getStreamNonChunked(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_putStreamNonChunked(HCkRest cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC BOOL CkRest_getUtf8(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_putUtf8(HCkRest cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC BOOL CkRest_getVerboseLogging(HCkRest cHandle);
CK_VISIBLE_PUBLIC void CkRest_putVerboseLogging(HCkRest cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkRest_FullRequestFormUrlEncoded(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkRest_fullRequestFormUrlEncoded(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC HCkTask CkRest_FullRequestFormUrlEncodedAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRest_FullRequestMultipart(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkRest_fullRequestMultipart(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC HCkTask CkRest_FullRequestMultipartAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath);
...
CK_VISIBLE_PUBLIC HCkTask CkRest_ReadRespBodyBinaryAsync(HCkRest cHandle);
CK_VISIBLE_PUBLIC BOOL CkRest_ReadRespBodyStream(HCkRest cHandle, HCkStream stream, BOOL autoSetStreamCharset);
CK_VISIBLE_PUBLIC HCkTask CkRest_ReadRespBodyStreamAsync(HCkRest cHandle, HCkStream stream, BOOL autoSetStreamCharset);
CK_VISIBLE_PUBLIC BOOL CkRest_ReadRespBodyString(HCkRest cHandle, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkRest_readRespBodyString(HCkRest cHandle);
CK_VISIBLE_PUBLIC HCkTask CkRest_ReadRespBodyStringAsync(HCkRest cHandle);
CK_VISIBLE_PUBLIC int CkRest_ReadResponseHeader(HCkRest cHandle);
CK_VISIBLE_PUBLIC HCkTask CkRest_ReadResponseHeaderAsync(HCkRest cHandle);
CK_VISIBLE_PUBLIC BOOL CkRest_ReadRespSb(HCkRest cHandle, HCkStringBuilder responseBody);
CK_VISIBLE_PUBLIC HCkTask CkRest_ReadRespSbAsync(HCkRest cHandle, HCkStringBuilder responseBody);
CK_VISIBLE_PUBLIC HCkUrl CkRest_RedirectUrl(HCkRest cHandle);
CK_VISIBLE_PUBLIC BOOL CkRest_RemoveHeader(HCkRest cHandle, const char *name);
CK_VISIBLE_PUBLIC BOOL CkRest_RemoveQueryParam(HCkRest cHandle, const char *name);
CK_VISIBLE_PUBLIC BOOL CkRest_ResponseHdrByName(HCkRest cHandle, const char *name, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkRest_responseHdrByName(HCkRest cHandle, const char *name);
CK_VISIBLE_PUBLIC BOOL CkRest_ResponseHdrName(HCkRest cHandle, int index, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkRest_responseHdrName(HCkRest cHandle, int index);
CK_VISIBLE_PUBLIC BOOL CkRest_ResponseHdrValue(HCkRest cHandle, int index, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkRest_responseHdrValue(HCkRest cHandle, int index);
CK_VISIBLE_PUBLIC BOOL CkRest_SaveLastError(HCkRest cHandle, const char *path);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqBd(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkBinData body);
CK_VISIBLE_PUBLIC HCkTask CkRest_SendReqBdAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkBinData body);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqBinaryBody(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkByteData body);
CK_VISIBLE_PUBLIC HCkTask CkRest_SendReqBinaryBodyAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkByteData body);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqFormUrlEncoded(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC HCkTask CkRest_SendReqFormUrlEncodedAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqMultipart(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC HCkTask CkRest_SendReqMultipartAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqNoBody(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC HCkTask CkRest_SendReqNoBodyAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqSb(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkStringBuilder bodySb);
CK_VISIBLE_PUBLIC HCkTask CkRest_SendReqSbAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkStringBuilder bodySb);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqStreamBody(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkStream stream);
CK_VISIBLE_PUBLIC HCkTask CkRest_SendReqStreamBodyAsync(HCkRest cHandle, const char *httpVerb, const char *uriPath, HCkStream stream);
CK_VISIBLE_PUBLIC BOOL CkRest_SendReqStringBody(HCkRest cHandle, const char *httpVerb, const char *uriPath, const char *bodyText);
...
CK_VISIBLE_PUBLIC BOOL CkRest_SetMultipartBodyBd(HCkRest cHandle, HCkBinData bodyData);
CK_VISIBLE_PUBLIC BOOL CkRest_SetMultipartBodyBinary(HCkRest cHandle, HCkByteData bodyData);
CK_VISIBLE_PUBLIC BOOL CkRest_SetMultipartBodySb(HCkRest cHandle, HCkStringBuilder bodySb);
...
CK_VISIBLE_PUBLIC BOOL CkRest_SetResponseBodyStream(HCkRest cHandle, int expectedStatus, BOOL autoSetStreamCharset, HCkStream responseStream);
CK_VISIBLE_PUBLIC BOOL CkRest_UseConnection(HCkRest cHandle, HCkSocket connection, BOOL autoReconnect);
#endif
