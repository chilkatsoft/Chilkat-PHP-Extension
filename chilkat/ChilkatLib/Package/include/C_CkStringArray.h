...
CK_VISIBLE_PUBLIC BOOL CkStringArray_getLastMethodSuccess(HCkStringArray cHandle);
CK_VISIBLE_PUBLIC void CkStringArray_putLastMethodSuccess(HCkStringArray cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkStringArray_LoadTaskResult(HCkStringArray cHandle, HCkTask task);
...
CK_VISIBLE_PUBLIC void CkStringArray_ReplaceAt(HCkStringArray cHandle, int index, const char *str);
