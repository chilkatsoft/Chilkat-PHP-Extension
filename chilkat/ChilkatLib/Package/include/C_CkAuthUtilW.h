...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthUtilW_debugLogFilePath(HCkAuthUtilW cHandle);
CK_VISIBLE_PUBLIC void CkAuthUtilW_getLastErrorHtml(HCkAuthUtilW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthUtilW_lastErrorHtml(HCkAuthUtilW cHandle);
CK_VISIBLE_PUBLIC void CkAuthUtilW_getLastErrorText(HCkAuthUtilW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthUtilW_lastErrorText(HCkAuthUtilW cHandle);
CK_VISIBLE_PUBLIC void CkAuthUtilW_getLastErrorXml(HCkAuthUtilW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthUtilW_lastErrorXml(HCkAuthUtilW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthUtilW_version(HCkAuthUtilW cHandle);
