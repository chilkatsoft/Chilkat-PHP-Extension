...
CK_VISIBLE_PUBLIC void CkUploadW_setAbortCheck(HCkUploadW cHandle, BOOL (*fnAbortCheck)(void));
CK_VISIBLE_PUBLIC void CkUploadW_setPercentDone(HCkUploadW cHandle, BOOL (*fnPercentDone)(int pctDone));
CK_VISIBLE_PUBLIC void CkUploadW_setProgressInfo(HCkUploadW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
CK_VISIBLE_PUBLIC void CkUploadW_setTaskCompleted(HCkUploadW cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));

CK_VISIBLE_PUBLIC HCkUploadW CkUploadW_Create(void);
CK_VISIBLE_PUBLIC void CkUploadW_Dispose(HCkUploadW handle);
CK_VISIBLE_PUBLIC BOOL CkUploadW_getAbortCurrent(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void  CkUploadW_putAbortCurrent(HCkUploadW cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC int CkUploadW_getBandwidthThrottleUp(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void  CkUploadW_putBandwidthThrottleUp(HCkUploadW cHandle, int newVal);
...
CK_VISIBLE_PUBLIC void CkUploadW_getClientIpAddress(HCkUploadW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkUploadW_putClientIpAddress(HCkUploadW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_clientIpAddress(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkUploadW_getLastMethodSuccess(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void  CkUploadW_putLastMethodSuccess(HCkUploadW cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC int CkUploadW_getPercentDoneScale(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void  CkUploadW_putPercentDoneScale(HCkUploadW cHandle, int newVal);
...
CK_VISIBLE_PUBLIC void CkUploadW_getSslAllowedCiphers(HCkUploadW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkUploadW_putSslAllowedCiphers(HCkUploadW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_sslAllowedCiphers(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void CkUploadW_getSslProtocol(HCkUploadW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkUploadW_putSslProtocol(HCkUploadW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_sslProtocol(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void CkUploadW_getTlsPinSet(HCkUploadW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkUploadW_putTlsPinSet(HCkUploadW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_tlsPinSet(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC void CkUploadW_AbortUpload(HCkUploadW cHandle);
#endif
...
#ifndef SINGLE_THREADED
CK_VISIBLE_PUBLIC BOOL CkUploadW_BeginUpload(HCkUploadW cHandle);
#endif
CK_VISIBLE_PUBLIC BOOL CkUploadW_BlockingUpload(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC HCkTaskW CkUploadW_BlockingUploadAsync(HCkUploadW cHandle);
