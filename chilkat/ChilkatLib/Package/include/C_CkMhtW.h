...
CK_VISIBLE_PUBLIC void  CkMhtW_putUnpackDirect(HCkMhtW cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkMhtW_GetAndSaveEML(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath, const wchar_t *emlPath);
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_GetAndSaveEMLAsync(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath, const wchar_t *emlPath);
CK_VISIBLE_PUBLIC BOOL CkMhtW_GetAndSaveMHT(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath, const wchar_t *mhtPath);
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_GetAndSaveMHTAsync(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath, const wchar_t *mhtPath);
...
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_GetAndZipEMLAsync(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath, const wchar_t *zipEntryFilename, const wchar_t *zipFilename);
...
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_GetAndZipMHTAsync(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath, const wchar_t *zipEntryFilename, const wchar_t *zipFilename);
...
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_GetEMLAsync(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath);
...
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_GetMHTAsync(HCkMhtW cHandle, const wchar_t *url_or_htmlFilepath);
...
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_HtmlToEMLAsync(HCkMhtW cHandle, const wchar_t *htmlText);
CK_VISIBLE_PUBLIC BOOL CkMhtW_HtmlToEMLFile(HCkMhtW cHandle, const wchar_t *html, const wchar_t *emlFilename);
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_HtmlToEMLFileAsync(HCkMhtW cHandle, const wchar_t *html, const wchar_t *emlFilename);
...
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_HtmlToMHTAsync(HCkMhtW cHandle, const wchar_t *htmlText);
CK_VISIBLE_PUBLIC BOOL CkMhtW_HtmlToMHTFile(HCkMhtW cHandle, const wchar_t *html, const wchar_t *mhtFilename);
CK_VISIBLE_PUBLIC HCkTaskW CkMhtW_HtmlToMHTFileAsync(HCkMhtW cHandle, const wchar_t *html, const wchar_t *mhtFilename);
...
CK_VISIBLE_PUBLIC BOOL CkMhtW_UnpackMHT(HCkMhtW cHandle, const wchar_t *mhtFilename, const wchar_t *unpackDir, const wchar_t *htmlFilename, const wchar_t *partsSubDir);
CK_VISIBLE_PUBLIC BOOL CkMhtW_UnpackMHTString(HCkMhtW cHandle, const wchar_t *mhtString, const wchar_t *unpackDir, const wchar_t *htmlFilename, const wchar_t *partsSubDir);
#endif
