...
CK_VISIBLE_PUBLIC BOOL CkCert_getLastMethodSuccess(HCkCert cHandle);
CK_VISIBLE_PUBLIC void CkCert_putLastMethodSuccess(HCkCert cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkCert_GetExtensionAsXml(HCkCert cHandle, const char *oid, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkCert_getExtensionAsXml(HCkCert cHandle, const char *oid);
...
CK_VISIBLE_PUBLIC BOOL CkCert_GetSpkiFingerprint(HCkCert cHandle, const char *hashAlg, const char *encoding, HCkString outStr);
...
CK_VISIBLE_PUBLIC BOOL CkCert_LoadTaskResult(HCkCert cHandle, HCkTask task);
