...
CK_VISIBLE_PUBLIC BOOL CkXmlCertVault_getLastMethodSuccess(HCkXmlCertVault cHandle);
CK_VISIBLE_PUBLIC void CkXmlCertVault_putLastMethodSuccess(HCkXmlCertVault cHandle, BOOL newVal);
