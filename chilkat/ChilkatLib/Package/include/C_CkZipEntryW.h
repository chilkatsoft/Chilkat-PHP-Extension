...
CK_VISIBLE_PUBLIC void CkZipEntryW_setAbortCheck(HCkZipEntryW cHandle, BOOL (*fnAbortCheck)(void));
CK_VISIBLE_PUBLIC void CkZipEntryW_setPercentDone(HCkZipEntryW cHandle, BOOL (*fnPercentDone)(int pctDone));
CK_VISIBLE_PUBLIC void CkZipEntryW_setProgressInfo(HCkZipEntryW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
CK_VISIBLE_PUBLIC void CkZipEntryW_setTaskCompleted(HCkZipEntryW cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_AppendStringAsync(HCkZipEntryW cHandle, const wchar_t *strContent, const wchar_t *charset);
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_ExtractAsync(HCkZipEntryW cHandle, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC BOOL CkZipEntryW_ExtractInto(HCkZipEntryW cHandle, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_ExtractIntoAsync(HCkZipEntryW cHandle, const wchar_t *dirPath);
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_InflateAsync(HCkZipEntryW cHandle);
CK_VISIBLE_PUBLIC HCkZipEntryW CkZipEntryW_NextEntry(HCkZipEntryW cHandle);
CK_VISIBLE_PUBLIC HCkZipEntryW CkZipEntryW_NextMatchingEntry(HCkZipEntryW cHandle, const wchar_t *matchStr);
...
CK_VISIBLE_PUBLIC BOOL CkZipEntryW_UnzipToBd(HCkZipEntryW cHandle, HCkBinDataW binData);
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_UnzipToBdAsync(HCkZipEntryW cHandle, HCkBinDataW binData);
CK_VISIBLE_PUBLIC BOOL CkZipEntryW_UnzipToSb(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset, HCkStringBuilderW sb);
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_UnzipToSbAsync(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset, HCkStringBuilderW sb);
CK_VISIBLE_PUBLIC BOOL CkZipEntryW_UnzipToStream(HCkZipEntryW cHandle, HCkStreamW toStream);
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_UnzipToStreamAsync(HCkZipEntryW cHandle, HCkStreamW toStream);
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipEntryW_UnzipToStringAsync(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset);
#endif
