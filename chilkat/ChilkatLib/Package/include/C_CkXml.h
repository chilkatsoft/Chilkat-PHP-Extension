...
CK_VISIBLE_PUBLIC BOOL CkXml_ChildContentMatches(HCkXml cHandle, const char *tagPath, const char *pattern, BOOL caseSensitive);
...
CK_VISIBLE_PUBLIC HCkXml CkXml_ExtractChildByName(HCkXml cHandle, const char *tagPath, const char *attrName, const char *attrValue);
CK_VISIBLE_PUBLIC HCkXml CkXml_FindChild(HCkXml cHandle, const char *tagPath);
CK_VISIBLE_PUBLIC BOOL CkXml_FindChild2(HCkXml cHandle, const char *tagPath);
CK_VISIBLE_PUBLIC HCkXml CkXml_FindNextRecord(HCkXml cHandle, const char *tagPath, const char *contentPattern);
CK_VISIBLE_PUBLIC HCkXml CkXml_FindOrAddNewChild(HCkXml cHandle, const char *tagPath);
...
CK_VISIBLE_PUBLIC BOOL CkXml_GetChildBoolValue(HCkXml cHandle, const char *tagPath);
CK_VISIBLE_PUBLIC BOOL CkXml_GetChildContent(HCkXml cHandle, const char *tagPath, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkXml_getChildContent(HCkXml cHandle, const char *tagPath);
...
CK_VISIBLE_PUBLIC int CkXml_GetChildIntValue(HCkXml cHandle, const char *tagPath);
...
CK_VISIBLE_PUBLIC HCkXml CkXml_GetChildWithAttr(HCkXml cHandle, const char *tagPath, const char *attrName, const char *attrValue);
CK_VISIBLE_PUBLIC HCkXml CkXml_GetChildWithContent(HCkXml cHandle, const char *content);
CK_VISIBLE_PUBLIC HCkXml CkXml_GetChildWithTag(HCkXml cHandle, const char *tagPath);
...
CK_VISIBLE_PUBLIC BOOL CkXml_HasChildWithTag(HCkXml cHandle, const char *tagPath);
CK_VISIBLE_PUBLIC BOOL CkXml_HasChildWithTagAndContent(HCkXml cHandle, const char *tagPath, const char *content);
...
CK_VISIBLE_PUBLIC HCkXml CkXml_NewChild(HCkXml cHandle, const char *tagPath, const char *content);
CK_VISIBLE_PUBLIC void CkXml_NewChild2(HCkXml cHandle, const char *tagPath, const char *content);
...
CK_VISIBLE_PUBLIC void CkXml_NewChildInt2(HCkXml cHandle, const char *tagPath, int value);
...
CK_VISIBLE_PUBLIC void CkXml_RemoveChild(HCkXml cHandle, const char *tagPath);
...
CK_VISIBLE_PUBLIC void CkXml_UpdateChildContent(HCkXml cHandle, const char *tagPath, const char *value);
CK_VISIBLE_PUBLIC void CkXml_UpdateChildContentInt(HCkXml cHandle, const char *tagPath, int value);
