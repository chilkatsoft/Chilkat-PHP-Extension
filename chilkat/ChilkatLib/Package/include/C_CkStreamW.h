...
CK_VISIBLE_PUBLIC void  CkStreamW_putLength(HCkStreamW cHandle, __int64 newVal);
CK_VISIBLE_PUBLIC int CkStreamW_getLength32(HCkStreamW cHandle);
CK_VISIBLE_PUBLIC void  CkStreamW_putLength32(HCkStreamW cHandle, int newVal);
...
CK_VISIBLE_PUBLIC void  CkStreamW_putSourceFilePartSize(HCkStreamW cHandle, int newVal);
