...
CK_VISIBLE_PUBLIC BOOL CkDirTree_getLastMethodSuccess(HCkDirTree cHandle);
CK_VISIBLE_PUBLIC void CkDirTree_putLastMethodSuccess(HCkDirTree cHandle, BOOL newVal);
