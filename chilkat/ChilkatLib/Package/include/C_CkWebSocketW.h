...
CK_VISIBLE_PUBLIC HCkWebSocketW CkWebSocketW_Create(void);
CK_VISIBLE_PUBLIC void CkWebSocketW_Dispose(HCkWebSocketW handle);
...
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_getPingAutoRespond(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC void  CkWebSocketW_putPingAutoRespond(HCkWebSocketW cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_getPongAutoConsume(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC void  CkWebSocketW_putPongAutoConsume(HCkWebSocketW cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_getPongConsumed(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC int CkWebSocketW_getReadFrameFailReason(HCkWebSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkWebSocketW_getFrameData(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_GetFrameDataBd(HCkWebSocketW cHandle, HCkBinDataW binData);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_GetFrameDataSb(HCkWebSocketW cHandle, HCkStringBuilderW sb);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_PollDataAvailable(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_ReadFrame(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC HCkTaskW CkWebSocketW_ReadFrameAsync(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_SaveLastError(HCkWebSocketW cHandle, const wchar_t *path);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_SendClose(HCkWebSocketW cHandle, BOOL includeStatus, int statusCode, const wchar_t *reason);
CK_VISIBLE_PUBLIC HCkTaskW CkWebSocketW_SendCloseAsync(HCkWebSocketW cHandle, BOOL includeStatus, int statusCode, const wchar_t *reason);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_SendFrame(HCkWebSocketW cHandle, const wchar_t *stringToSend, BOOL finalFrame);
CK_VISIBLE_PUBLIC HCkTaskW CkWebSocketW_SendFrameAsync(HCkWebSocketW cHandle, const wchar_t *stringToSend, BOOL finalFrame);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_SendFrameBd(HCkWebSocketW cHandle, HCkBinDataW bdToSend, BOOL finalFrame);
CK_VISIBLE_PUBLIC HCkTaskW CkWebSocketW_SendFrameBdAsync(HCkWebSocketW cHandle, HCkBinDataW bdToSend, BOOL finalFrame);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_SendFrameSb(HCkWebSocketW cHandle, HCkStringBuilderW sbToSend, BOOL finalFrame);
CK_VISIBLE_PUBLIC HCkTaskW CkWebSocketW_SendFrameSbAsync(HCkWebSocketW cHandle, HCkStringBuilderW sbToSend, BOOL finalFrame);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_SendPing(HCkWebSocketW cHandle, const wchar_t *pingData);
CK_VISIBLE_PUBLIC HCkTaskW CkWebSocketW_SendPingAsync(HCkWebSocketW cHandle, const wchar_t *pingData);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_SendPong(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC HCkTaskW CkWebSocketW_SendPongAsync(HCkWebSocketW cHandle);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_UseConnection(HCkWebSocketW cHandle, HCkRestW connection);
CK_VISIBLE_PUBLIC BOOL CkWebSocketW_ValidateServerHandshake(HCkWebSocketW cHandle);
#endif
