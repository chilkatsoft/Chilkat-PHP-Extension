...
CK_VISIBLE_PUBLIC void CkUpload_setAbortCheck(HCkUpload cHandle, BOOL (*fnAbortCheck)(void));
...
CK_VISIBLE_PUBLIC void CkUpload_getClientIpAddress(HCkUpload cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkUpload_putClientIpAddress(HCkUpload cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkUpload_clientIpAddress(HCkUpload cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkUpload_getLastMethodSuccess(HCkUpload cHandle);
CK_VISIBLE_PUBLIC void CkUpload_putLastMethodSuccess(HCkUpload cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC int CkUpload_getPercentDoneScale(HCkUpload cHandle);
CK_VISIBLE_PUBLIC void CkUpload_putPercentDoneScale(HCkUpload cHandle, int newVal);
...
CK_VISIBLE_PUBLIC void CkUpload_getSslAllowedCiphers(HCkUpload cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkUpload_putSslAllowedCiphers(HCkUpload cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkUpload_sslAllowedCiphers(HCkUpload cHandle);
CK_VISIBLE_PUBLIC void CkUpload_getSslProtocol(HCkUpload cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkUpload_putSslProtocol(HCkUpload cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkUpload_sslProtocol(HCkUpload cHandle);
CK_VISIBLE_PUBLIC void CkUpload_getTlsPinSet(HCkUpload cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkUpload_putTlsPinSet(HCkUpload cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkUpload_tlsPinSet(HCkUpload cHandle);
...
CK_VISIBLE_PUBLIC void CkUpload_AbortUpload(HCkUpload cHandle);
#endif
...
#ifndef SINGLE_THREADED
CK_VISIBLE_PUBLIC BOOL CkUpload_BeginUpload(HCkUpload cHandle);
#endif
CK_VISIBLE_PUBLIC BOOL CkUpload_BlockingUpload(HCkUpload cHandle);
CK_VISIBLE_PUBLIC HCkTask CkUpload_BlockingUploadAsync(HCkUpload cHandle);
