...
CK_VISIBLE_PUBLIC BOOL CkHtmlToText_getLastMethodSuccess(HCkHtmlToText cHandle);
CK_VISIBLE_PUBLIC void CkHtmlToText_putLastMethodSuccess(HCkHtmlToText cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkHtmlToText_WriteStringToFile(HCkHtmlToText cHandle, const char *stringToWrite, const char *filename, const char *charset);
#endif
