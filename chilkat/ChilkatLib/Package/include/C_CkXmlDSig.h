...
CK_VISIBLE_PUBLIC HCkXmlDSig CkXmlDSig_Create(void);
CK_VISIBLE_PUBLIC void CkXmlDSig_Dispose(HCkXmlDSig handle);
...
CK_VISIBLE_PUBLIC const char *CkXmlDSig_lastErrorText(HCkXmlDSig cHandle);
CK_VISIBLE_PUBLIC void CkXmlDSig_getLastErrorXml(HCkXmlDSig cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkXmlDSig_lastErrorXml(HCkXmlDSig cHandle);
CK_VISIBLE_PUBLIC BOOL CkXmlDSig_getLastMethodSuccess(HCkXmlDSig cHandle);
...
CK_VISIBLE_PUBLIC void CkXmlDSig_putUtf8(HCkXmlDSig cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC BOOL CkXmlDSig_getVerboseLogging(HCkXmlDSig cHandle);
CK_VISIBLE_PUBLIC void CkXmlDSig_putVerboseLogging(HCkXmlDSig cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC void CkXmlDSig_getVersion(HCkXmlDSig cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkXmlDSig_version(HCkXmlDSig cHandle);
CK_VISIBLE_PUBLIC BOOL CkXmlDSig_getWithComments(HCkXmlDSig cHandle);
CK_VISIBLE_PUBLIC void CkXmlDSig_putWithComments(HCkXmlDSig cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC BOOL CkXmlDSig_CanonicalizeFragment(HCkXmlDSig cHandle, const char *xml, const char *fragmentId, const char *version, const char *prefixList, BOOL withComments, HCkString outStr);
...
CK_VISIBLE_PUBLIC BOOL CkXmlDSig_LoadSignatureSb(HCkXmlDSig cHandle, HCkStringBuilder sbXmlSig);
