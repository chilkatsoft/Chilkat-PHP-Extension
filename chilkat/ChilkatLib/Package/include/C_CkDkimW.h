...
CK_VISIBLE_PUBLIC BOOL CkDkimW_getLastMethodSuccess(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC HCkTaskW CkDkimW_VerifyDomainKeySignatureAsync(HCkDkimW cHandle, int sigIndex, HCkByteData mimeData);
#endif
