...
CK_VISIBLE_PUBLIC BOOL CkStringArrayW_LoadTaskResult(HCkStringArrayW cHandle, HCkTaskW task);
...
CK_VISIBLE_PUBLIC void CkStringArrayW_ReplaceAt(HCkStringArrayW cHandle, int index, const wchar_t *str);
