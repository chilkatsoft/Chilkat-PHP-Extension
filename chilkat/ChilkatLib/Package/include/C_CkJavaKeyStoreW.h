...
CK_VISIBLE_PUBLIC HCkJavaKeyStoreW CkJavaKeyStoreW_Create(void);
...
CK_VISIBLE_PUBLIC BOOL CkJavaKeyStoreW_getVerboseLogging(HCkJavaKeyStoreW cHandle);
CK_VISIBLE_PUBLIC void  CkJavaKeyStoreW_putVerboseLogging(HCkJavaKeyStoreW cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC HCkPrivateKeyW CkJavaKeyStoreW_FindPrivateKey(HCkJavaKeyStoreW cHandle, const wchar_t *password, const wchar_t *alias, BOOL caseSensitive);
CK_VISIBLE_PUBLIC HCkCertW CkJavaKeyStoreW_FindTrustedCert(HCkJavaKeyStoreW cHandle, const wchar_t *alias, BOOL caseSensitive);
CK_VISIBLE_PUBLIC HCkCertChainW CkJavaKeyStoreW_GetCertChain(HCkJavaKeyStoreW cHandle, int index);
...
CK_VISIBLE_PUBLIC BOOL CkJavaKeyStoreW_ToBinary(HCkJavaKeyStoreW cHandle, const wchar_t *password, HCkByteData outBytes);
...
CK_VISIBLE_PUBLIC BOOL CkJavaKeyStoreW_UseCertVault(HCkJavaKeyStoreW cHandle, HCkXmlCertVaultW vault);
#endif
