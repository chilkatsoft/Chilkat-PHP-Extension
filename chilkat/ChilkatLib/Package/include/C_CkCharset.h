...
CK_VISIBLE_PUBLIC BOOL CkCharset_getLastMethodSuccess(HCkCharset cHandle);
CK_VISIBLE_PUBLIC void CkCharset_putLastMethodSuccess(HCkCharset cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkCharset_ConvertFile(HCkCharset cHandle, const char *inPath, const char *destPath);
CK_VISIBLE_PUBLIC BOOL CkCharset_ConvertFileNoPreamble(HCkCharset cHandle, const char *inPath, const char *destPath);
...
CK_VISIBLE_PUBLIC BOOL CkCharset_ConvertHtmlFile(HCkCharset cHandle, const char *inPath, const char *destPath);
...
CK_VISIBLE_PUBLIC BOOL CkCharset_HtmlEntityDecodeFile(HCkCharset cHandle, const char *inPath, const char *destPath);
