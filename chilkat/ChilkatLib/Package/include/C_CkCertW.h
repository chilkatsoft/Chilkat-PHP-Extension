...
CK_VISIBLE_PUBLIC BOOL CkCertW_GetExtensionAsXml(HCkCertW cHandle, const wchar_t *oid, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getExtensionAsXml(HCkCertW cHandle, const wchar_t *oid);
...
CK_VISIBLE_PUBLIC BOOL CkCertW_GetSpkiFingerprint(HCkCertW cHandle, const wchar_t *hashAlg, const wchar_t *encoding, HCkString outStr);
...
CK_VISIBLE_PUBLIC BOOL CkCertW_LoadTaskResult(HCkCertW cHandle, HCkTaskW task);
