...
CK_VISIBLE_PUBLIC BOOL CkKeyContainer_getLastMethodSuccess(HCkKeyContainer cHandle);
CK_VISIBLE_PUBLIC void CkKeyContainer_putLastMethodSuccess(HCkKeyContainer cHandle, BOOL newVal);
