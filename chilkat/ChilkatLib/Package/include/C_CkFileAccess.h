...
CK_VISIBLE_PUBLIC BOOL CkFileAccess_getLastMethodSuccess(HCkFileAccess cHandle);
CK_VISIBLE_PUBLIC void CkFileAccess_putLastMethodSuccess(HCkFileAccess cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC HCkDateTime CkFileAccess_GetFileTime(HCkFileAccess cHandle, const char *path, int which);
