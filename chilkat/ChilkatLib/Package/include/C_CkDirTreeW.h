...
CK_VISIBLE_PUBLIC BOOL CkDirTreeW_getLastMethodSuccess(HCkDirTreeW cHandle);
CK_VISIBLE_PUBLIC void  CkDirTreeW_putLastMethodSuccess(HCkDirTreeW cHandle, BOOL newVal);
