...
CK_VISIBLE_PUBLIC BOOL CkBinData_GetString(HCkBinData cHandle, const char *charset, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkBinData_getString(HCkBinData cHandle, const char *charset);
...
CK_VISIBLE_PUBLIC BOOL CkBinData_SecureClear(HCkBinData cHandle);
