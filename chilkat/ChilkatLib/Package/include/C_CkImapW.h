...
CK_VISIBLE_PUBLIC BOOL CkImapW_GetQuota(HCkImapW cHandle, const wchar_t *quotaRoot, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getQuota(HCkImapW cHandle, const wchar_t *quotaRoot);
CK_VISIBLE_PUBLIC HCkTaskW CkImapW_GetQuotaAsync(HCkImapW cHandle, const wchar_t *quotaRoot);
CK_VISIBLE_PUBLIC BOOL CkImapW_GetQuotaRoot(HCkImapW cHandle, const wchar_t *mailboxName, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getQuotaRoot(HCkImapW cHandle, const wchar_t *mailboxName);
CK_VISIBLE_PUBLIC HCkTaskW CkImapW_GetQuotaRootAsync(HCkImapW cHandle, const wchar_t *mailboxName);
CK_VISIBLE_PUBLIC HCkCertW CkImapW_GetSslServerCert(HCkImapW cHandle);
CK_VISIBLE_PUBLIC BOOL CkImapW_HasCapability(HCkImapW cHandle, const wchar_t *name, const wchar_t *capabilityResponse);
...
CK_VISIBLE_PUBLIC BOOL CkImapW_SetQuota(HCkImapW cHandle, const wchar_t *quotaRoot, const wchar_t *resource, int quota);
CK_VISIBLE_PUBLIC HCkTaskW CkImapW_SetQuotaAsync(HCkImapW cHandle, const wchar_t *quotaRoot, const wchar_t *resource, int quota);
