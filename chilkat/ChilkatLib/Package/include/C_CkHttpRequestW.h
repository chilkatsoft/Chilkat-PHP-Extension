...
CK_VISIBLE_PUBLIC BOOL CkHttpRequestW_AddSubHeader(HCkHttpRequestW cHandle, int index, const wchar_t *name, const wchar_t *value);
CK_VISIBLE_PUBLIC BOOL CkHttpRequestW_GenerateRequestFile(HCkHttpRequestW cHandle, const wchar_t *path);
...
CK_VISIBLE_PUBLIC BOOL CkHttpRequestW_StreamChunkFromFile(HCkHttpRequestW cHandle, const wchar_t *path, const wchar_t *offset, const wchar_t *numBytes);
