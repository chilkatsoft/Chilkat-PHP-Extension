...
CK_VISIBLE_PUBLIC void CkHttpResponse_getFinalRedirectUrl(HCkHttpResponse cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkHttpResponse_finalRedirectUrl(HCkHttpResponse cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkHttpResponse_getLastMethodSuccess(HCkHttpResponse cHandle);
CK_VISIBLE_PUBLIC void CkHttpResponse_putLastMethodSuccess(HCkHttpResponse cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC void CkHttpResponse_getStatusText(HCkHttpResponse cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkHttpResponse_statusText(HCkHttpResponse cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkHttpResponse_GetBodyBd(HCkHttpResponse cHandle, HCkBinData binData);
CK_VISIBLE_PUBLIC BOOL CkHttpResponse_GetBodySb(HCkHttpResponse cHandle, HCkStringBuilder sb);
...
CK_VISIBLE_PUBLIC BOOL CkHttpResponse_LoadTaskResult(HCkHttpResponse cHandle, HCkTask task);
