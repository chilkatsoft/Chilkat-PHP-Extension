...
CK_VISIBLE_PUBLIC BOOL CkJwsW_getPreferCompact(HCkJwsW cHandle);
CK_VISIBLE_PUBLIC void  CkJwsW_putPreferCompact(HCkJwsW cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC BOOL CkJwsW_getPreferFlattened(HCkJwsW cHandle);
CK_VISIBLE_PUBLIC void  CkJwsW_putPreferFlattened(HCkJwsW cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkJwsW_GetPayload(HCkJwsW cHandle, const wchar_t *charset, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkJwsW_getPayload(HCkJwsW cHandle, const wchar_t *charset);
...
CK_VISIBLE_PUBLIC BOOL CkJwsW_SetMacKey(HCkJwsW cHandle, int index, const wchar_t *key, const wchar_t *encoding);
CK_VISIBLE_PUBLIC BOOL CkJwsW_SetMacKeyBd(HCkJwsW cHandle, int index, HCkBinDataW key);
CK_VISIBLE_PUBLIC BOOL CkJwsW_SetPayload(HCkJwsW cHandle, const wchar_t *payload, const wchar_t *charset, BOOL includeBom);
