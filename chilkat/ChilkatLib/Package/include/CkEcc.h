...
class CK_VISIBLE_PUBLIC CkEcc  : public CkMultiByteBase
{
	...
	// Generates an ECC private key using a specified value for K. The ARG1 specifies
	// the curve name which determines the key size. The ARG2 is the encoded value of
	// the private key. The ARG3 is the encoding used for ARG2, which can be "hex",
	// "base64", "decimal", etc.
	// 
