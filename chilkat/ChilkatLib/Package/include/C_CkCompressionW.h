...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginCompressBytesENCAsync(HCkCompressionW cHandle, HCkByteData data);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_BeginCompressString(HCkCompressionW cHandle, const wchar_t *str, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginCompressStringAsync(HCkCompressionW cHandle, const wchar_t *str);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginCompressStringENCAsync(HCkCompressionW cHandle, const wchar_t *str);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_BeginDecompressBytes(HCkCompressionW cHandle, HCkByteData data, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginDecompressBytesAsync(HCkCompressionW cHandle, HCkByteData data);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginDecompressBytesENCAsync(HCkCompressionW cHandle, const wchar_t *str);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginDecompressStringAsync(HCkCompressionW cHandle, HCkByteData data);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_CompressStringAsync(HCkCompressionW cHandle, const wchar_t *str);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_DecompressStringAsync(HCkCompressionW cHandle, HCkByteData data);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_DecompressStringENCAsync(HCkCompressionW cHandle, const wchar_t *encodedCompressedData);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_EndCompressBytes(HCkCompressionW cHandle, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndCompressBytesAsync(HCkCompressionW cHandle);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndCompressBytesENCAsync(HCkCompressionW cHandle);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_EndCompressString(HCkCompressionW cHandle, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndCompressStringAsync(HCkCompressionW cHandle);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndCompressStringENCAsync(HCkCompressionW cHandle);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_EndDecompressBytes(HCkCompressionW cHandle, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndDecompressBytesAsync(HCkCompressionW cHandle);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_EndDecompressBytesENC(HCkCompressionW cHandle, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndDecompressBytesENCAsync(HCkCompressionW cHandle);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndDecompressStringAsync(HCkCompressionW cHandle);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_EndDecompressStringENCAsync(HCkCompressionW cHandle);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_MoreCompressBytes(HCkCompressionW cHandle, HCkByteData data, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreCompressBytesAsync(HCkCompressionW cHandle, HCkByteData data);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreCompressBytesENCAsync(HCkCompressionW cHandle, HCkByteData data);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_MoreCompressString(HCkCompressionW cHandle, const wchar_t *str, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreCompressStringAsync(HCkCompressionW cHandle, const wchar_t *str);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreCompressStringENCAsync(HCkCompressionW cHandle, const wchar_t *str);
CK_VISIBLE_PUBLIC BOOL CkCompressionW_MoreDecompressBytes(HCkCompressionW cHandle, HCkByteData data, HCkByteData outData);
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreDecompressBytesAsync(HCkCompressionW cHandle, HCkByteData data);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreDecompressBytesENCAsync(HCkCompressionW cHandle, const wchar_t *str);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreDecompressStringAsync(HCkCompressionW cHandle, HCkByteData data);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreDecompressStringENCAsync(HCkCompressionW cHandle, const wchar_t *str);
