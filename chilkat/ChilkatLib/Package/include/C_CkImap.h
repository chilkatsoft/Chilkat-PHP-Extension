...
CK_VISIBLE_PUBLIC BOOL CkImap_getLastMethodSuccess(HCkImap cHandle);
CK_VISIBLE_PUBLIC void CkImap_putLastMethodSuccess(HCkImap cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC int CkImap_getPercentDoneScale(HCkImap cHandle);
CK_VISIBLE_PUBLIC void CkImap_putPercentDoneScale(HCkImap cHandle, int newVal);
...
CK_VISIBLE_PUBLIC void CkImap_getSeparatorChar(HCkImap cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkImap_putSeparatorChar(HCkImap cHandle, const char *newVal);
...
CK_VISIBLE_PUBLIC void CkImap_putSslAllowedCiphers(HCkImap cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkImap_sslAllowedCiphers(HCkImap cHandle);
...
CK_VISIBLE_PUBLIC void CkImap_getTlsCipherSuite(HCkImap cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkImap_tlsCipherSuite(HCkImap cHandle);
CK_VISIBLE_PUBLIC void CkImap_getTlsPinSet(HCkImap cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkImap_putTlsPinSet(HCkImap cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkImap_tlsPinSet(HCkImap cHandle);
CK_VISIBLE_PUBLIC void CkImap_getTlsVersion(HCkImap cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkImap_tlsVersion(HCkImap cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkImap_CheckConnection(HCkImap cHandle);
CK_VISIBLE_PUBLIC HCkMessageSet CkImap_CheckForNewEmail(HCkImap cHandle);
CK_VISIBLE_PUBLIC HCkTask CkImap_CheckForNewEmailAsync(HCkImap cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_CloseMailboxAsync(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC BOOL CkImap_Connect(HCkImap cHandle, const char *domainName);
CK_VISIBLE_PUBLIC HCkTask CkImap_ConnectAsync(HCkImap cHandle, const char *domainName);
CK_VISIBLE_PUBLIC BOOL CkImap_Copy(HCkImap cHandle, int msgId, BOOL bUid, const char *copyToMailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_CopyAsync(HCkImap cHandle, int msgId, BOOL bUid, const char *copyToMailbox);
CK_VISIBLE_PUBLIC BOOL CkImap_CopyMultiple(HCkImap cHandle, HCkMessageSet messageSet, const char *copyToMailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_CopyMultipleAsync(HCkImap cHandle, HCkMessageSet messageSet, const char *copyToMailbox);
CK_VISIBLE_PUBLIC BOOL CkImap_CopySequence(HCkImap cHandle, int startSeqNum, int count, const char *copyToMailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_CopySequenceAsync(HCkImap cHandle, int startSeqNum, int count, const char *copyToMailbox);
CK_VISIBLE_PUBLIC BOOL CkImap_CreateMailbox(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_CreateMailboxAsync(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC BOOL CkImap_DeleteMailbox(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_DeleteMailboxAsync(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC BOOL CkImap_Disconnect(HCkImap cHandle);
CK_VISIBLE_PUBLIC HCkTask CkImap_DisconnectAsync(HCkImap cHandle);
CK_VISIBLE_PUBLIC BOOL CkImap_ExamineMailbox(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_ExamineMailboxAsync(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC BOOL CkImap_Expunge(HCkImap cHandle);
CK_VISIBLE_PUBLIC HCkTask CkImap_ExpungeAsync(HCkImap cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchBundleAsync(HCkImap cHandle, HCkMessageSet messageSet);
CK_VISIBLE_PUBLIC HCkStringArray CkImap_FetchBundleAsMime(HCkImap cHandle, HCkMessageSet messageSet);
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchBundleAsMimeAsync(HCkImap cHandle, HCkMessageSet messageSet);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchChunkAsync(HCkImap cHandle, int startSeqNum, int count, HCkMessageSet failedSet, HCkMessageSet fetchedSet);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchFlagsAsync(HCkImap cHandle, int msgId, BOOL bUid);
CK_VISIBLE_PUBLIC HCkEmailBundle CkImap_FetchHeaders(HCkImap cHandle, HCkMessageSet messageSet);
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchHeadersAsync(HCkImap cHandle, HCkMessageSet messageSet);
CK_VISIBLE_PUBLIC HCkEmailBundle CkImap_FetchSequence(HCkImap cHandle, int startSeqNum, int numMessages);
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchSequenceAsync(HCkImap cHandle, int startSeqNum, int numMessages);
CK_VISIBLE_PUBLIC HCkStringArray CkImap_FetchSequenceAsMime(HCkImap cHandle, int startSeqNum, int numMessages);
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchSequenceAsMimeAsync(HCkImap cHandle, int startSeqNum, int numMessages);
CK_VISIBLE_PUBLIC HCkEmailBundle CkImap_FetchSequenceHeaders(HCkImap cHandle, int startSeqNum, int numMessages);
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchSequenceHeadersAsync(HCkImap cHandle, int startSeqNum, int numMessages);
CK_VISIBLE_PUBLIC HCkEmail CkImap_FetchSingle(HCkImap cHandle, int msgId, BOOL bUid);
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleAsync(HCkImap cHandle, int msgId, BOOL bUid);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleHeaderAsMimeAsync(HCkImap cHandle, int msgId, BOOL bUID);
CK_VISIBLE_PUBLIC HCkMessageSet CkImap_GetAllUids(HCkImap cHandle);
CK_VISIBLE_PUBLIC HCkTask CkImap_GetAllUidsAsync(HCkImap cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_IdleDoneAsync(HCkImap cHandle);
CK_VISIBLE_PUBLIC BOOL CkImap_IdleStart(HCkImap cHandle);
CK_VISIBLE_PUBLIC HCkTask CkImap_IdleStartAsync(HCkImap cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_RefetchMailFlagsAsync(HCkImap cHandle, HCkEmail email);
CK_VISIBLE_PUBLIC BOOL CkImap_RenameMailbox(HCkImap cHandle, const char *fromMailbox, const char *toMailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_RenameMailboxAsync(HCkImap cHandle, const char *fromMailbox, const char *toMailbox);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_SearchAsync(HCkImap cHandle, const char *criteria, BOOL bUid);
CK_VISIBLE_PUBLIC BOOL CkImap_SelectMailbox(HCkImap cHandle, const char *mailbox);
CK_VISIBLE_PUBLIC HCkTask CkImap_SelectMailboxAsync(HCkImap cHandle, const char *mailbox);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_SendRawCommandAsync(HCkImap cHandle, const char *cmd);
CK_VISIBLE_PUBLIC BOOL CkImap_SendRawCommandB(HCkImap cHandle, const char *cmd, HCkByteData outBytes);
CK_VISIBLE_PUBLIC HCkTask CkImap_SendRawCommandBAsync(HCkImap cHandle, const char *cmd);
CK_VISIBLE_PUBLIC BOOL CkImap_SendRawCommandC(HCkImap cHandle, HCkByteData cmd, HCkByteData outBytes);
CK_VISIBLE_PUBLIC HCkTask CkImap_SendRawCommandCAsync(HCkImap cHandle, HCkByteData cmd);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_SetFlagAsync(HCkImap cHandle, int msgId, BOOL bUid, const char *flagName, int value);
...
CK_VISIBLE_PUBLIC HCkTask CkImap_SshAuthenticatePwAsync(HCkImap cHandle, const char *sshLogin, const char *sshPassword);
CK_VISIBLE_PUBLIC BOOL CkImap_SshCloseTunnel(HCkImap cHandle);
CK_VISIBLE_PUBLIC HCkTask CkImap_SshCloseTunnelAsync(HCkImap cHandle);
CK_VISIBLE_PUBLIC BOOL CkImap_SshOpenTunnel(HCkImap cHandle, const char *sshHostname, int sshPort);
CK_VISIBLE_PUBLIC HCkTask CkImap_SshOpenTunnelAsync(HCkImap cHandle, const char *sshHostname, int sshPort);
...
CK_VISIBLE_PUBLIC BOOL CkImap_UseSsh(HCkImap cHandle, HCkSsh ssh);
CK_VISIBLE_PUBLIC BOOL CkImap_UseSshTunnel(HCkImap cHandle, HCkSocket tunnel);
#endif
