...
CK_VISIBLE_PUBLIC BOOL CkMailMan_getAutoUnwrapSecurity(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC void CkMailMan_putAutoUnwrapSecurity(HCkMailMan cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkMailMan_getIsPop3Connected(HCkMailMan cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkMailMan_getLastMethodSuccess(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC void CkMailMan_putLastMethodSuccess(HCkMailMan cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC void CkMailMan_getSmtpFailReason(HCkMailMan cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkMailMan_smtpFailReason(HCkMailMan cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkMailMan_getSmtpPipelining(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC void CkMailMan_putSmtpPipelining(HCkMailMan cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkMailMan_getStartTLSifPossible(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC void CkMailMan_putStartTLSifPossible(HCkMailMan cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC void CkMailMan_getTlsCipherSuite(HCkMailMan cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkMailMan_tlsCipherSuite(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC void CkMailMan_getTlsPinSet(HCkMailMan cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkMailMan_putTlsPinSet(HCkMailMan cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkMailMan_tlsPinSet(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC void CkMailMan_getTlsVersion(HCkMailMan cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkMailMan_tlsVersion(HCkMailMan cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_CheckMailAsync(HCkMailMan cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_CloseSmtpConnectionAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkEmailBundle CkMailMan_CopyMail(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_CopyMailAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_DeleteBundle(HCkMailMan cHandle, HCkEmailBundle emailBundle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_DeleteBundleAsync(HCkMailMan cHandle, HCkEmailBundle emailBundle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_DeleteByMsgnum(HCkMailMan cHandle, int msgnum);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_DeleteByMsgnumAsync(HCkMailMan cHandle, int msgnum);
CK_VISIBLE_PUBLIC BOOL CkMailMan_DeleteByUidl(HCkMailMan cHandle, const char *uidl);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_DeleteByUidlAsync(HCkMailMan cHandle, const char *uidl);
CK_VISIBLE_PUBLIC BOOL CkMailMan_DeleteEmail(HCkMailMan cHandle, HCkEmail email);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_DeleteEmailAsync(HCkMailMan cHandle, HCkEmail email);
CK_VISIBLE_PUBLIC BOOL CkMailMan_DeleteMultiple(HCkMailMan cHandle, HCkStringArray uidlArray);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_DeleteMultipleAsync(HCkMailMan cHandle, HCkStringArray uidlArray);
CK_VISIBLE_PUBLIC HCkEmail CkMailMan_FetchByMsgnum(HCkMailMan cHandle, int msgnum);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_FetchByMsgnumAsync(HCkMailMan cHandle, int msgnum);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_FetchMultipleAsync(HCkMailMan cHandle, HCkStringArray uidlArray);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_FetchMultipleHeadersAsync(HCkMailMan cHandle, HCkStringArray uidlArray, int numBodyLines);
CK_VISIBLE_PUBLIC HCkStringArray CkMailMan_FetchMultipleMime(HCkMailMan cHandle, HCkStringArray uidlArray);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_FetchMultipleMimeAsync(HCkMailMan cHandle, HCkStringArray uidlArray);
CK_VISIBLE_PUBLIC HCkEmail CkMailMan_FetchSingleHeader(HCkMailMan cHandle, int numBodyLines, int messageNumber);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_FetchSingleHeaderAsync(HCkMailMan cHandle, int numBodyLines, int messageNumber);
CK_VISIBLE_PUBLIC HCkEmail CkMailMan_FetchSingleHeaderByUidl(HCkMailMan cHandle, int numBodyLines, const char *uidl);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_FetchSingleHeaderByUidlAsync(HCkMailMan cHandle, int numBodyLines, const char *uidl);
CK_VISIBLE_PUBLIC HCkEmailBundle CkMailMan_GetAllHeaders(HCkMailMan cHandle, int numBodyLines);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_GetAllHeadersAsync(HCkMailMan cHandle, int numBodyLines);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_GetFullEmailAsync(HCkMailMan cHandle, HCkEmail email);
CK_VISIBLE_PUBLIC HCkEmailBundle CkMailMan_GetHeaders(HCkMailMan cHandle, int numBodyLines, int fromIndex, int toIndex);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_GetHeadersAsync(HCkMailMan cHandle, int numBodyLines, int fromIndex, int toIndex);
CK_VISIBLE_PUBLIC int CkMailMan_GetMailboxCount(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_GetMailboxCountAsync(HCkMailMan cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_GetSizeByUidlAsync(HCkMailMan cHandle, const char *uidl);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_GetUidlsAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_IsSmtpDsnCapable(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_IsSmtpDsnCapableAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_IsUnlocked(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkJsonObject CkMailMan_LastJsonData(HCkMailMan cHandle);
...
#if defined(CK_SMTPQ_INCLUDED)
CK_VISIBLE_PUBLIC HCkEmail CkMailMan_LoadQueuedEmail(HCkMailMan cHandle, const char *path);
#endif
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_Pop3EndSessionNoQuitAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_Pop3Noop(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_Pop3NoopAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_Pop3Reset(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_Pop3ResetAsync(HCkMailMan cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_Pop3SendRawCommandAsync(HCkMailMan cHandle, const char *command, const char *charset);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SendMimeToListAsync(HCkMailMan cHandle, const char *fromAddr, const char *distListFilename, const char *mimeSource);
#if defined(CK_SMTPQ_INCLUDED)
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SendToDistributionListAsync(HCkMailMan cHandle, HCkEmail emailObj, HCkStringArray recipientList);
...
CK_VISIBLE_PUBLIC BOOL CkMailMan_SmtpAuthenticate(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SmtpAuthenticateAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_SmtpConnect(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SmtpConnectAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_SmtpNoop(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SmtpNoopAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_SmtpReset(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SmtpResetAsync(HCkMailMan cHandle);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SmtpSendRawCommandAsync(HCkMailMan cHandle, const char *command, const char *charset, BOOL bEncodeBase64);
CK_VISIBLE_PUBLIC BOOL CkMailMan_SshAuthenticatePk(HCkMailMan cHandle, const char *sshLogin, HCkSshKey sshUsername);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SshAuthenticatePkAsync(HCkMailMan cHandle, const char *sshLogin, HCkSshKey sshUsername);
CK_VISIBLE_PUBLIC BOOL CkMailMan_SshAuthenticatePw(HCkMailMan cHandle, const char *sshLogin, const char *sshPassword);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SshAuthenticatePwAsync(HCkMailMan cHandle, const char *sshLogin, const char *sshPassword);
CK_VISIBLE_PUBLIC BOOL CkMailMan_SshCloseTunnel(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SshCloseTunnelAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_SshOpenTunnel(HCkMailMan cHandle, const char *sshHostname, int sshPort);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_SshOpenTunnelAsync(HCkMailMan cHandle, const char *sshHostname, int sshPort);
CK_VISIBLE_PUBLIC HCkEmailBundle CkMailMan_TransferMail(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_TransferMailAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkStringArray CkMailMan_TransferMultipleMime(HCkMailMan cHandle, HCkStringArray uidlArray);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_TransferMultipleMimeAsync(HCkMailMan cHandle, HCkStringArray uidlArray);
...
CK_VISIBLE_PUBLIC BOOL CkMailMan_UseSsh(HCkMailMan cHandle, HCkSsh ssh);
...
CK_VISIBLE_PUBLIC HCkTask CkMailMan_VerifyPopConnectionAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_VerifyPopLogin(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_VerifyPopLoginAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_VerifyRecips(HCkMailMan cHandle, HCkEmail email, HCkStringArray badAddrs);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_VerifyRecipsAsync(HCkMailMan cHandle, HCkEmail email, HCkStringArray badAddrs);
CK_VISIBLE_PUBLIC BOOL CkMailMan_VerifySmtpConnection(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_VerifySmtpConnectionAsync(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC BOOL CkMailMan_VerifySmtpLogin(HCkMailMan cHandle);
CK_VISIBLE_PUBLIC HCkTask CkMailMan_VerifySmtpLoginAsync(HCkMailMan cHandle);
#endif
