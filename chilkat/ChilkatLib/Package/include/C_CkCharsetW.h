...
CK_VISIBLE_PUBLIC BOOL CkCharsetW_ConvertFile(HCkCharsetW cHandle, const wchar_t *inPath, const wchar_t *destPath);
CK_VISIBLE_PUBLIC BOOL CkCharsetW_ConvertFileNoPreamble(HCkCharsetW cHandle, const wchar_t *inPath, const wchar_t *destPath);
...
CK_VISIBLE_PUBLIC BOOL CkCharsetW_ConvertHtmlFile(HCkCharsetW cHandle, const wchar_t *inPath, const wchar_t *destPath);
...
CK_VISIBLE_PUBLIC BOOL CkCharsetW_HtmlEntityDecodeFile(HCkCharsetW cHandle, const wchar_t *inPath, const wchar_t *destPath);
