...
CK_VISIBLE_PUBLIC BOOL CkDateTime_getLastMethodSuccess(HCkDateTime cHandle);
CK_VISIBLE_PUBLIC void CkDateTime_putLastMethodSuccess(HCkDateTime cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkDateTime_AddSeconds(HCkDateTime cHandle, int numSeconds);
CK_VISIBLE_PUBLIC void CkDateTime_DeSerialize(HCkDateTime cHandle, const char *serializedDateTime);
CK_VISIBLE_PUBLIC int CkDateTime_DiffSeconds(HCkDateTime cHandle, HCkDateTime dateTimeArg);
CK_VISIBLE_PUBLIC BOOL CkDateTime_ExpiresWithin(HCkDateTime cHandle, int n, const char *units);
CK_VISIBLE_PUBLIC BOOL CkDateTime_GetAsDateTime(HCkDateTime cHandle, BOOL bLocal, SYSTEMTIME *outDate);
...
#endif
CK_VISIBLE_PUBLIC BOOL CkDateTime_GetAsIso8601(HCkDateTime cHandle, const char *formatStr, BOOL bLocal, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkDateTime_getAsIso8601(HCkDateTime cHandle, const char *formatStr, BOOL bLocal);
...
CK_VISIBLE_PUBLIC BOOL CkDateTime_GetAsUnixTimeStr(HCkDateTime cHandle, BOOL bLocal, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkDateTime_getAsUnixTimeStr(HCkDateTime cHandle, BOOL bLocal);
#if !defined(CK_USE_UINT_T)
...
#endif
CK_VISIBLE_PUBLIC HCkDtObj CkDateTime_GetDtObj(HCkDateTime cHandle, BOOL bLocal);
CK_VISIBLE_PUBLIC BOOL CkDateTime_LoadTaskResult(HCkDateTime cHandle, HCkTask task);
CK_VISIBLE_PUBLIC BOOL CkDateTime_OlderThan(HCkDateTime cHandle, int n, const char *units);
...
CK_VISIBLE_PUBLIC BOOL CkDateTime_SetFromCurrentSystemTime(HCkDateTime cHandle);
CK_VISIBLE_PUBLIC BOOL CkDateTime_SetFromDateTimeTicks(HCkDateTime cHandle, BOOL bLocal, __int64 ticks);
#if !defined(CK_USE_UINT_T)
CK_VISIBLE_PUBLIC BOOL CkDateTime_SetFromDosDate(HCkDateTime cHandle, BOOL bLocal, unsigned long t);
#endif
#if !defined(CK_USE_UINT_T)
CK_VISIBLE_PUBLIC BOOL CkDateTime_SetFromDosDate2(HCkDateTime cHandle, BOOL bLocal, unsigned short datePart, unsigned short timePart);
#endif
CK_VISIBLE_PUBLIC BOOL CkDateTime_SetFromDtObj(HCkDateTime cHandle, HCkDtObj dt);
CK_VISIBLE_PUBLIC BOOL CkDateTime_SetFromNtpTime(HCkDateTime cHandle, int ntpSeconds);
CK_VISIBLE_PUBLIC BOOL CkDateTime_SetFromOleDate(HCkDateTime cHandle, BOOL bLocal, double dt);
