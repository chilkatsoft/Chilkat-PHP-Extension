...
CK_VISIBLE_PUBLIC BOOL CkHtmlToXml_getLastMethodSuccess(HCkHtmlToXml cHandle);
CK_VISIBLE_PUBLIC void CkHtmlToXml_putLastMethodSuccess(HCkHtmlToXml cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkHtmlToXml_WriteStringToFile(HCkHtmlToXml cHandle, const char *stringToWrite, const char *filename, const char *charset);
