...
CK_VISIBLE_PUBLIC BOOL CkRestW_Disconnect(HCkRestW cHandle, int maxWaitMs);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_DisconnectAsync(HCkRestW cHandle, int maxWaitMs);
CK_VISIBLE_PUBLIC BOOL CkRestW_FullRequestBd(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkBinDataW binData, HCkStringBuilderW responseBody);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_FullRequestBdAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkBinDataW binData, HCkStringBuilderW responseBody);
CK_VISIBLE_PUBLIC BOOL CkRestW_FullRequestBinary(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkByteData bodyBytes, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_fullRequestBinary(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkByteData bodyBytes);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_FullRequestBinaryAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkByteData bodyBytes);
CK_VISIBLE_PUBLIC BOOL CkRestW_FullRequestFormUrlEncoded(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_fullRequestFormUrlEncoded(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_FullRequestFormUrlEncodedAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRestW_FullRequestMultipart(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_fullRequestMultipart(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_FullRequestMultipartAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRestW_FullRequestNoBody(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkString outStr);
...
CK_VISIBLE_PUBLIC BOOL CkRestW_FullRequestNoBodyBd(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkBinDataW binData);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_FullRequestNoBodyBdAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkBinDataW binData);
CK_VISIBLE_PUBLIC BOOL CkRestW_FullRequestNoBodySb(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkStringBuilderW sb);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_FullRequestNoBodySbAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkStringBuilderW sb);
...
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_ReadRespBodyBinaryAsync(HCkRestW cHandle);
CK_VISIBLE_PUBLIC BOOL CkRestW_ReadRespBodyStream(HCkRestW cHandle, HCkStreamW stream, BOOL autoSetStreamCharset);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_ReadRespBodyStreamAsync(HCkRestW cHandle, HCkStreamW stream, BOOL autoSetStreamCharset);
CK_VISIBLE_PUBLIC BOOL CkRestW_ReadRespBodyString(HCkRestW cHandle, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_readRespBodyString(HCkRestW cHandle);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_ReadRespBodyStringAsync(HCkRestW cHandle);
CK_VISIBLE_PUBLIC int CkRestW_ReadResponseHeader(HCkRestW cHandle);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_ReadResponseHeaderAsync(HCkRestW cHandle);
CK_VISIBLE_PUBLIC BOOL CkRestW_ReadRespSb(HCkRestW cHandle, HCkStringBuilderW responseBody);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_ReadRespSbAsync(HCkRestW cHandle, HCkStringBuilderW responseBody);
CK_VISIBLE_PUBLIC HCkUrlW CkRestW_RedirectUrl(HCkRestW cHandle);
CK_VISIBLE_PUBLIC BOOL CkRestW_RemoveHeader(HCkRestW cHandle, const wchar_t *name);
CK_VISIBLE_PUBLIC BOOL CkRestW_RemoveQueryParam(HCkRestW cHandle, const wchar_t *name);
CK_VISIBLE_PUBLIC BOOL CkRestW_ResponseHdrByName(HCkRestW cHandle, const wchar_t *name, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_responseHdrByName(HCkRestW cHandle, const wchar_t *name);
CK_VISIBLE_PUBLIC BOOL CkRestW_ResponseHdrName(HCkRestW cHandle, int index, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_responseHdrName(HCkRestW cHandle, int index);
CK_VISIBLE_PUBLIC BOOL CkRestW_ResponseHdrValue(HCkRestW cHandle, int index, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkRestW_responseHdrValue(HCkRestW cHandle, int index);
CK_VISIBLE_PUBLIC BOOL CkRestW_SaveLastError(HCkRestW cHandle, const wchar_t *path);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqBd(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkBinDataW body);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqBdAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkBinDataW body);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqBinaryBody(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkByteData body);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqBinaryBodyAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkByteData body);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqFormUrlEncoded(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqFormUrlEncodedAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqMultipart(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqMultipartAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqNoBody(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqNoBodyAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqSb(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkStringBuilderW bodySb);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqSbAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkStringBuilderW bodySb);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqStreamBody(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkStreamW stream);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqStreamBodyAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, HCkStreamW stream);
CK_VISIBLE_PUBLIC BOOL CkRestW_SendReqStringBody(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, const wchar_t *bodyText);
CK_VISIBLE_PUBLIC HCkTaskW CkRestW_SendReqStringBodyAsync(HCkRestW cHandle, const wchar_t *httpVerb, const wchar_t *uriPath, const wchar_t *bodyText);
CK_VISIBLE_PUBLIC BOOL CkRestW_SetAuthAws(HCkRestW cHandle, HCkAuthAwsW authProvider);
CK_VISIBLE_PUBLIC BOOL CkRestW_SetAuthAzureAD(HCkRestW cHandle, HCkAuthAzureADW authProvider);
...
CK_VISIBLE_PUBLIC BOOL CkRestW_SetMultipartBodyBd(HCkRestW cHandle, HCkBinDataW bodyData);
CK_VISIBLE_PUBLIC BOOL CkRestW_SetMultipartBodyBinary(HCkRestW cHandle, HCkByteData bodyData);
CK_VISIBLE_PUBLIC BOOL CkRestW_SetMultipartBodySb(HCkRestW cHandle, HCkStringBuilderW bodySb);
CK_VISIBLE_PUBLIC BOOL CkRestW_SetMultipartBodyStream(HCkRestW cHandle, HCkStreamW stream);
CK_VISIBLE_PUBLIC BOOL CkRestW_SetMultipartBodyString(HCkRestW cHandle, const wchar_t *bodyText);
CK_VISIBLE_PUBLIC BOOL CkRestW_SetResponseBodyStream(HCkRestW cHandle, int expectedStatus, BOOL autoSetStreamCharset, HCkStreamW responseStream);
CK_VISIBLE_PUBLIC BOOL CkRestW_UseConnection(HCkRestW cHandle, HCkSocketW connection, BOOL autoReconnect);
#endif
