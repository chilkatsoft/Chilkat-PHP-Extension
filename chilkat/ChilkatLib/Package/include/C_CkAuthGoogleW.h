...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_accessToken(HCkAuthGoogleW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_debugLogFilePath(HCkAuthGoogleW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_lastErrorHtml(HCkAuthGoogleW cHandle);
CK_VISIBLE_PUBLIC void CkAuthGoogleW_getLastErrorText(HCkAuthGoogleW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_lastErrorText(HCkAuthGoogleW cHandle);
CK_VISIBLE_PUBLIC void CkAuthGoogleW_getLastErrorXml(HCkAuthGoogleW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_lastErrorXml(HCkAuthGoogleW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_scope(HCkAuthGoogleW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_subEmailAddress(HCkAuthGoogleW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthGoogleW_version(HCkAuthGoogleW cHandle);
