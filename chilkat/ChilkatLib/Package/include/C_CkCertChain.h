...
CK_VISIBLE_PUBLIC BOOL CkCertChain_getLastMethodSuccess(HCkCertChain cHandle);
CK_VISIBLE_PUBLIC void CkCertChain_putLastMethodSuccess(HCkCertChain cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkCertChain_getReachesRoot(HCkCertChain cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkCertChain_LoadX5C(HCkCertChain cHandle, HCkJsonObject jwk);
