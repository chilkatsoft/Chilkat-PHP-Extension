...
CK_VISIBLE_PUBLIC BOOL CkCertChainW_getLastMethodSuccess(HCkCertChainW cHandle);
CK_VISIBLE_PUBLIC void  CkCertChainW_putLastMethodSuccess(HCkCertChainW cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkCertChainW_getReachesRoot(HCkCertChainW cHandle);
