...
CK_VISIBLE_PUBLIC void CkBz2W_setAbortCheck(HCkBz2W cHandle, BOOL (*fnAbortCheck)(void));
CK_VISIBLE_PUBLIC void CkBz2W_setPercentDone(HCkBz2W cHandle, BOOL (*fnPercentDone)(int pctDone));
CK_VISIBLE_PUBLIC void CkBz2W_setProgressInfo(HCkBz2W cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
CK_VISIBLE_PUBLIC void CkBz2W_setTaskCompleted(HCkBz2W cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));
...
CK_VISIBLE_PUBLIC BOOL CkBz2W_getLastMethodSuccess(HCkBz2W cHandle);
CK_VISIBLE_PUBLIC void  CkBz2W_putLastMethodSuccess(HCkBz2W cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC BOOL CkBz2W_CompressFile(HCkBz2W cHandle, const wchar_t *inFilename, const wchar_t *toPath);
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_CompressFileAsync(HCkBz2W cHandle, const wchar_t *inFilename, const wchar_t *toPath);
CK_VISIBLE_PUBLIC BOOL CkBz2W_CompressFileToMem(HCkBz2W cHandle, const wchar_t *inFilename, HCkByteData outBytes);
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_CompressFileToMemAsync(HCkBz2W cHandle, const wchar_t *inFilename);
CK_VISIBLE_PUBLIC BOOL CkBz2W_CompressMemory(HCkBz2W cHandle, HCkByteData inData, HCkByteData outBytes);
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_CompressMemoryAsync(HCkBz2W cHandle, HCkByteData inData);
CK_VISIBLE_PUBLIC BOOL CkBz2W_CompressMemToFile(HCkBz2W cHandle, HCkByteData inData, const wchar_t *toPath);
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_CompressMemToFileAsync(HCkBz2W cHandle, HCkByteData inData, const wchar_t *toPath);
...
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_UncompressFileAsync(HCkBz2W cHandle, const wchar_t *inFilename, const wchar_t *toPath);
CK_VISIBLE_PUBLIC BOOL CkBz2W_UncompressFileToMem(HCkBz2W cHandle, const wchar_t *inFilename, HCkByteData outBytes);
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_UncompressFileToMemAsync(HCkBz2W cHandle, const wchar_t *inFilename);
CK_VISIBLE_PUBLIC BOOL CkBz2W_UncompressMemory(HCkBz2W cHandle, HCkByteData inData, HCkByteData outBytes);
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_UncompressMemoryAsync(HCkBz2W cHandle, HCkByteData inData);
CK_VISIBLE_PUBLIC BOOL CkBz2W_UncompressMemToFile(HCkBz2W cHandle, HCkByteData inData, const wchar_t *toPath);
CK_VISIBLE_PUBLIC HCkTaskW CkBz2W_UncompressMemToFileAsync(HCkBz2W cHandle, HCkByteData inData, const wchar_t *toPath);
