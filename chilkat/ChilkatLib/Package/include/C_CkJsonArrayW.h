...
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_AddNullAt(HCkJsonArrayW cHandle, int index);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_AddNumberAt(HCkJsonArrayW cHandle, int index, const wchar_t *numericStr);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_AddObjectAt(HCkJsonArrayW cHandle, int index);
...
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_EmitSb(HCkJsonArrayW cHandle, HCkStringBuilderW sb);
CK_VISIBLE_PUBLIC int CkJsonArrayW_FindObject(HCkJsonArrayW cHandle, const wchar_t *name, const wchar_t *value, BOOL caseSensitive);
CK_VISIBLE_PUBLIC int CkJsonArrayW_FindString(HCkJsonArrayW cHandle, const wchar_t *value, BOOL caseSensitive);
...
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_Load(HCkJsonArrayW cHandle, const wchar_t *jsonArray);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_LoadSb(HCkJsonArrayW cHandle, HCkStringBuilderW sb);
CK_VISIBLE_PUBLIC HCkJsonObjectW CkJsonArrayW_ObjectAt(HCkJsonArrayW cHandle, int index);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_SaveLastError(HCkJsonArrayW cHandle, const wchar_t *path);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_SetBoolAt(HCkJsonArrayW cHandle, int index, BOOL value);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_SetIntAt(HCkJsonArrayW cHandle, int index, int value);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_SetNullAt(HCkJsonArrayW cHandle, int index);
CK_VISIBLE_PUBLIC BOOL CkJsonArrayW_SetNumberAt(HCkJsonArrayW cHandle, int index, const wchar_t *value);
