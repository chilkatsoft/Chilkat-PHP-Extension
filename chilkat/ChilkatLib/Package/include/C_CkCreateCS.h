...
CK_VISIBLE_PUBLIC BOOL CkCreateCS_getLastMethodSuccess(HCkCreateCS cHandle);
CK_VISIBLE_PUBLIC void CkCreateCS_putLastMethodSuccess(HCkCreateCS cHandle, BOOL newVal);
