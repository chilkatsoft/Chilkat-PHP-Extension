...
CK_VISIBLE_PUBLIC BOOL CkSshTunnelW_getPreferIpv6(HCkSshTunnelW cHandle);
CK_VISIBLE_PUBLIC void  CkSshTunnelW_putPreferIpv6(HCkSshTunnelW cHandle, BOOL newVal);
