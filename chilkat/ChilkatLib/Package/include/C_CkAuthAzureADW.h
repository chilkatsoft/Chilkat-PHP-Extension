...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_accessToken(HCkAuthAzureADW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_clientId(HCkAuthAzureADW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_clientSecret(HCkAuthAzureADW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_debugLogFilePath(HCkAuthAzureADW cHandle);
CK_VISIBLE_PUBLIC void CkAuthAzureADW_getLastErrorHtml(HCkAuthAzureADW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_lastErrorHtml(HCkAuthAzureADW cHandle);
CK_VISIBLE_PUBLIC void CkAuthAzureADW_getLastErrorText(HCkAuthAzureADW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_lastErrorText(HCkAuthAzureADW cHandle);
CK_VISIBLE_PUBLIC void CkAuthAzureADW_getLastErrorXml(HCkAuthAzureADW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_lastErrorXml(HCkAuthAzureADW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_resource(HCkAuthAzureADW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_tenantId(HCkAuthAzureADW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkAuthAzureADW_version(HCkAuthAzureADW cHandle);
