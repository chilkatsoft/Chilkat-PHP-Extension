...
CK_VISIBLE_PUBLIC int CkCgiW_getAsyncBytesRead(HCkCgiW cHandle);
CK_VISIBLE_PUBLIC BOOL CkCgiW_getAsyncInProgress(HCkCgiW cHandle);
CK_VISIBLE_PUBLIC int CkCgiW_getAsyncPostSize(HCkCgiW cHandle);
...
CK_VISIBLE_PUBLIC int CkCgiW_getSizeLimitKB(HCkCgiW cHandle);
CK_VISIBLE_PUBLIC void  CkCgiW_putSizeLimitKB(HCkCgiW cHandle, int newVal);
...
CK_VISIBLE_PUBLIC int CkCgiW_GetUploadSize(HCkCgiW cHandle, int index);
