...
CK_VISIBLE_PUBLIC HCkTaskW CkCrypt2W_HashFileAsync(HCkCrypt2W cHandle, const wchar_t *filename);
...
CK_VISIBLE_PUBLIC HCkTaskW CkCrypt2W_HashFileENCAsync(HCkCrypt2W cHandle, const wchar_t *filename);
