...
CK_VISIBLE_PUBLIC BOOL CkCreateCSW_getLastMethodSuccess(HCkCreateCSW cHandle);
CK_VISIBLE_PUBLIC void CkCreateCSW_putLastMethodSuccess(HCkCreateCSW cHandle, BOOL newVal);
