...
CK_VISIBLE_PUBLIC BOOL CkZipW_getAbortCurrent(HCkZipW cHandle);
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_AppendFilesExAsync(HCkZipW cHandle, const wchar_t *filePattern, BOOL recurse, BOOL saveExtraPath, BOOL archiveOnly, BOOL includeHidden, BOOL includeSystem);
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_AppendMultipleAsync(HCkZipW cHandle, HCkStringArrayW fileSpecs, BOOL recurse);
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_AppendOneFileOrDirAsync(HCkZipW cHandle, const wchar_t *fileOrDirPath, BOOL saveExtraPath);
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_ExtractAsync(HCkZipW cHandle, const wchar_t *dirPath);
#if defined(CK_SFX_INCLUDED)
CK_VISIBLE_PUBLIC BOOL CkZipW_ExtractExe(HCkZipW cHandle, const wchar_t *exePath, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_ExtractExeAsync(HCkZipW cHandle, const wchar_t *exePath, const wchar_t *dirPath);
#endif
...
CK_VISIBLE_PUBLIC BOOL CkZipW_OpenBd(HCkZipW cHandle, HCkBinDataW binData);
#if defined(CK_SFX_INCLUDED)
...
#endif
CK_VISIBLE_PUBLIC BOOL CkZipW_OpenZip(HCkZipW cHandle, const wchar_t *zipPath);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_OpenZipAsync(HCkZipW cHandle, const wchar_t *zipPath);
CK_VISIBLE_PUBLIC BOOL CkZipW_QuickAppend(HCkZipW cHandle, const wchar_t *ZipFileName);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_QuickAppendAsync(HCkZipW cHandle, const wchar_t *ZipFileName);
#if defined(CK_SFX_INCLUDED)
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_UnzipAsync(HCkZipW cHandle, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC int CkZipW_UnzipInto(HCkZipW cHandle, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_UnzipIntoAsync(HCkZipW cHandle, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC int CkZipW_UnzipMatching(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_UnzipMatchingAsync(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);
CK_VISIBLE_PUBLIC int CkZipW_UnzipMatchingInto(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_UnzipMatchingIntoAsync(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);
CK_VISIBLE_PUBLIC int CkZipW_UnzipNewer(HCkZipW cHandle, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_UnzipNewerAsync(HCkZipW cHandle, const wchar_t *dirPath);
CK_VISIBLE_PUBLIC BOOL CkZipW_VerifyPassword(HCkZipW cHandle);
CK_VISIBLE_PUBLIC BOOL CkZipW_WriteBd(HCkZipW cHandle, HCkBinDataW binData);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_WriteBdAsync(HCkZipW cHandle, HCkBinDataW binData);
#if defined(CK_SFX_INCLUDED)
...
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_WriteToMemoryAsync(HCkZipW cHandle);
CK_VISIBLE_PUBLIC BOOL CkZipW_WriteZip(HCkZipW cHandle);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_WriteZipAsync(HCkZipW cHandle);
CK_VISIBLE_PUBLIC BOOL CkZipW_WriteZipAndClose(HCkZipW cHandle);
CK_VISIBLE_PUBLIC HCkTaskW CkZipW_WriteZipAndCloseAsync(HCkZipW cHandle);
#endif
