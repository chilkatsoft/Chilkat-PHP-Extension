...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_from(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkEmailW_getLastMethodSuccess(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void  CkEmailW_putLastMethodSuccess(HCkEmailW cHandle, BOOL newVal);
...
CK_VISIBLE_PUBLIC int CkEmailW_getNumDigests(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC void CkEmailW_getSigningAlg(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkEmailW_putSigningAlg(HCkEmailW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_signingAlg(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkEmailW_AddAttachmentBd(HCkEmailW cHandle, const wchar_t *filename, HCkBinDataW binData, const wchar_t *contentType);
...
CK_VISIBLE_PUBLIC BOOL CkEmailW_AddDataAttachment(HCkEmailW cHandle, const wchar_t *fileName, HCkByteData content);
CK_VISIBLE_PUBLIC BOOL CkEmailW_AddDataAttachment2(HCkEmailW cHandle, const wchar_t *fileName, HCkByteData content, const wchar_t *contentType);
...
CK_VISIBLE_PUBLIC BOOL CkEmailW_AddRelatedBd(HCkEmailW cHandle, const wchar_t *filename, HCkBinDataW binData, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_addRelatedBd(HCkEmailW cHandle, const wchar_t *filename, HCkBinDataW binData);
CK_VISIBLE_PUBLIC BOOL CkEmailW_AddRelatedBd2(HCkEmailW cHandle, HCkBinDataW binData, const wchar_t *fileNameInHtml);
CK_VISIBLE_PUBLIC BOOL CkEmailW_AddRelatedData(HCkEmailW cHandle, const wchar_t *fileName, HCkByteData inData, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_addRelatedData(HCkEmailW cHandle, const wchar_t *fileName, HCkByteData inData);
...
CK_VISIBLE_PUBLIC void CkEmailW_AddRelatedString2(HCkEmailW cHandle, const wchar_t *fileNameInHtml, const wchar_t *content, const wchar_t *charset);
...
CK_VISIBLE_PUBLIC BOOL CkEmailW_GetAlternativeBodyBd(HCkEmailW cHandle, int index, HCkBinDataW binData);
...
CK_VISIBLE_PUBLIC BOOL CkEmailW_GetAttachmentBd(HCkEmailW cHandle, int index, HCkBinDataW binData);
...
CK_VISIBLE_PUBLIC HCkEmailW CkEmailW_GetDigest(HCkEmailW cHandle, int index);
...
CK_VISIBLE_PUBLIC BOOL CkEmailW_LoadTaskResult(HCkEmailW cHandle, HCkTaskW task);
