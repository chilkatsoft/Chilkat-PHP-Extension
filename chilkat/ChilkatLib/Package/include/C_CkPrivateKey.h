...
CK_VISIBLE_PUBLIC void CkPrivateKey_getKeyType(HCkPrivateKey cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const char *CkPrivateKey_keyType(HCkPrivateKey cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkPrivateKey_getLastMethodSuccess(HCkPrivateKey cHandle);
CK_VISIBLE_PUBLIC void CkPrivateKey_putLastMethodSuccess(HCkPrivateKey cHandle, BOOL newVal);
CK_VISIBLE_PUBLIC void CkPrivateKey_getPkcs8EncryptAlg(HCkPrivateKey cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkPrivateKey_putPkcs8EncryptAlg(HCkPrivateKey cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkPrivateKey_pkcs8EncryptAlg(HCkPrivateKey cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkPrivateKey_GetPkcs8EncryptedENC(HCkPrivateKey cHandle, const char *encoding, const char *password, HCkString outStr);
CK_VISIBLE_PUBLIC const char *CkPrivateKey_getPkcs8EncryptedENC(HCkPrivateKey cHandle, const char *encoding, const char *password);
...
CK_VISIBLE_PUBLIC HCkPublicKey CkPrivateKey_GetPublicKey(HCkPrivateKey cHandle);
...
CK_VISIBLE_PUBLIC BOOL CkPrivateKey_LoadAnyFormat(HCkPrivateKey cHandle, HCkBinData privKeyData, const char *password);
