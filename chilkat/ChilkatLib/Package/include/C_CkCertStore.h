...
CK_VISIBLE_PUBLIC BOOL CkCertStore_getLastMethodSuccess(HCkCertStore cHandle);
CK_VISIBLE_PUBLIC void CkCertStore_putLastMethodSuccess(HCkCertStore cHandle, BOOL newVal);
...
#endif
#if defined(CK_WINCERTSTORE_INCLUDED)
CK_VISIBLE_PUBLIC BOOL CkCertStore_OpenWindowsStore(HCkCertStore cHandle, const char *storeLocation, const char *storeName, BOOL readOnly);
#endif
#if defined(CK_WINCERTSTORE_INCLUDED)
